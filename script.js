...
const getProgramData = () => {
  ...
  programData.map((program) => {
    ...
    div.innerHTML = ` <img src=${program.image} alt="icon" class="program-card-img">
...
const handlePopup = (speakerIndex) => {
  ...
  if (speakerIndex === false) {
    ...
    div.innerHTML = `<div class="speakers-popup-cont">
...
const getPastSummit = () => {
  ...
  pastSummitData.map((summit) => {
    const div = document.createElement('div');
    div.classList = 'past-summit-cards';
    div.innerHTML = `<img src=${summit.image} alt=" past summit" class="past-summit-image">
